...
<body>
    ...
    <div class="container" style="margin-top: 30px;">
        <div class="row">
            <div class="col-lg-4">
                <a href="<?php echo site_url('News/news_insert');?>">
                    <button type="button" class="btn btn-primary">Add</button>
                </a>
            </div>
            <div class="col-lg-4">
                <?php echo form_open('News/news_search');?>
    ...
    ?>
                <tr>
                    <td>
                        <?php echo $list['news_number']; ?>
                    </td>
                    <td>
                        <?php echo $list['news_header']; ?>
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        <a href="<?php echo site_url('News/news_delete') ?>/<?php echo $list['news_number']; ?>">
